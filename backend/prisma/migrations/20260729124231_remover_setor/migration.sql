/*
  ...
  - You are about to drop the column `setorId` on the `Colaborador` table. All the data in the column will be lost.
  - You are about to drop the column `setorId` on the `Equipamento` table. All the data in the column will be lost.
  - You are about to drop the column `setorAnteriorId` on the `Manutencao` table. All the data in the column will be lost.
  - You are about to drop the column `setorAnteriorId` on the `Movimentacao` table. All the data in the column will be lost.
  - You are about to drop the column `setorNovoId` on the `Movimentacao` table. All the data in the column will be lost.
